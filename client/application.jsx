...
export function Application() {
    ...
    function isAuthed() {
        ...
        return {
            auth: google ? {google: true, openid: false}
                : openid ? {google: false, openid: true}
                    : {google: false, openid: false}
        }
    }
    ...
    return (
        <div className={"parent"}>
            ...
            <header>
                ...
                {isAuthed().auth.openid ? <Link to={"/article/new"}>Add articles</Link> : ""}
